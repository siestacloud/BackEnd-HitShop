...
type Accounts struct {
	...
	AccountEmail           string `gorm:"column:account_email;					type:varchar(30);"`
	AccountVerify          bool   `gorm:"column:account_verify;					type:boolean;"`
	AccountPasswordHash    string `gorm:"column:account_password_hash;	type:varchar(30);"`
	AccountPhoneNumberHash string `gorm:"column:account_phone_number;		type:varchar(30);"`
}
